...
<html lang="en">
  <head>
    ...
    <title>Hello Again  DevOps Students of RMIT Vietnam, This is a test file!!!</title>
  </head>
  <body>
    ...
    <div class="jumbotron">
      ...
      <pre class="lead">This is a very simple website template that uses bootstrap CSS framework! This is a new code to push for the github SCM poll!
      ...
      <p>This is the new change that involves Jenkins, Maven, Ansible, Docker, ... in the pipeline! Woohoo!
